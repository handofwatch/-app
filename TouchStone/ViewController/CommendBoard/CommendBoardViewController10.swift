//
//  CommendBoardViewController10.swift
//  TouchStone
//
...
class CommendBoardViewController10: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    private(set) lazy var allViewControllers: [UIViewController] = {
        return [self.getViewController(identifier: "50"),self.getViewController(identifier: "49")]
    }()
