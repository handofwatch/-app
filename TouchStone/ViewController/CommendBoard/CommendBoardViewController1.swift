...
class CommendBoardViewController1: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    private(set) lazy var allViewControllers: [UIViewController] = {
        return [self.getViewController(identifier: "2"),
                self.getViewController(identifier: "3"),self.getViewController(identifier: "4"),
                self.getViewController(identifier: "5"),self.getViewController(identifier: "6")]
    }()
