//
//  CommendBoardViewController9.swift
//  TouchStone
//
...
class CommendBoardViewController9: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    private(set) lazy var allViewControllers: [UIViewController] = {
        return [self.getViewController(identifier: "47")]
    }()
