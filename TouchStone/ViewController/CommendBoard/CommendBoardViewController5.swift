//
//  CommendBoardViewController5.swift
//  TouchStone
//
...
class CommendBoardViewController5: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    private(set) lazy var allViewControllers: [UIViewController] = {
        return [self.getViewController(identifier: "25"),self.getViewController(identifier: "26"),
                self.getViewController(identifier: "28"),self.getViewController(identifier: "27"),
                self.getViewController(identifier: "29")]
    }()
