...
class CommendViewController10: UIViewController {
    
    //场景切换
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let pageViewController = segue.destination as? CommendBoardViewController10 {
