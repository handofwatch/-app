//
//  CommendBoardViewController8.swift
//  TouchStone
//
...
class CommendBoardViewController8: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    private(set) lazy var allViewControllers: [UIViewController] = {
        return [self.getViewController(identifier: "43"),self.getViewController(identifier: "44"),self.getViewController(identifier: "45")]
    }()
