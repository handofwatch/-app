//
//  CommendBoardViewController7.swift
//  TouchStone
//
...
class CommendBoardViewController7: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    private(set) lazy var allViewControllers: [UIViewController] = {
        return [self.getViewController(identifier: "36"),
                ...
                self.getViewController(identifier: "41")]
    }()
