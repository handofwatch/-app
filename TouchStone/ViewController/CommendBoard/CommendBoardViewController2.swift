//
//  CommendBoardViewController2.swift
//  TouchStone
//
...
class CommendBoardViewController2: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    private(set) lazy var allViewControllers: [UIViewController] = {
        return [self.getViewController(identifier: "8"),
