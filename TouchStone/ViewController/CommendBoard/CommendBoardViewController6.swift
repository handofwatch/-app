//
//  CommendBoardViewController6.swift
//  TouchStone
//
...
class CommendBoardViewController6: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    private(set) lazy var allViewControllers: [UIViewController] = {
        return [self.getViewController(identifier: "32"),self.getViewController(identifier: "31"),
