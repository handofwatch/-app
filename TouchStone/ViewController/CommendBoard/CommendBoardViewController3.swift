//
//  CommendBoardViewController3.swift
//  TouchStone
//
...
class CommendBoardViewController3: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    private(set) lazy var allViewControllers: [UIViewController] = {
        return [self.getViewController(identifier: "14"),
                self.getViewController(identifier: "15"),self.getViewController(identifier: "17"),self.getViewController(identifier: "16"),self.getViewController(identifier: "18")]
    }()
