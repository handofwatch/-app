//
//  CommendBoardViewController4.swift
//  TouchStone
//
...
class CommendBoardViewController4: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    private(set) lazy var allViewControllers: [UIViewController] = {
        return [self.getViewController(identifier: "20"),
                self.getViewController(identifier: "21"),self.getViewController(identifier: "22"),
                self.getViewController(identifier: "23")]
    }()
